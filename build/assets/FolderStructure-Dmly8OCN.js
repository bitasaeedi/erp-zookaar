import{j as s}from"./index-EjvHy6Kc.js";import{S as t}from"./SyntaxHighlighter-aihePEGP.js";import"./toConsumableArray-0PR8dQxs.js";import"./extends-CF3RwP-h.js";const r=()=>s.jsxs(s.Fragment,{children:[s.jsx("p",{children:"در این بخش، ساختار اولیه پوشه‌ها و هر چیزی که برای راه‌اندازی و اجرای قالب نیاز دارید را پیدا خواهید کرد. نسخه‌های دمو و استارتر ساختار یکسانی دارند، با این تفاوت که نسخه استارتر شامل فایل‌ها و پوشه‌های کمتری است زیرا برخی از آن‌ها در نسخه استارتر لازم نیستند."}),s.jsx("p",{children:"در زیر یک نمودار شماتیک از ساختار پوشه‌ها آورده شده است:"}),s.jsx(t,{children:`
    ...
    `}),s.jsx("p",{children:"این ساختار پوشه، سازماندهی واضحی از منابع، کامپوننت‌ها، تنظیمات و دارایی‌ها ارائه می‌دهد و مدیریت و توسعه پروژه را آسان‌تر می‌کند. هر پوشه و فایل به‌صورت هدفمند قرار داده شده تا کد منظم و قابل نگهداری باشد."})]});export{r as default};
